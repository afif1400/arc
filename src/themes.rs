...
impl Theme {
    pub fn node_style(&self, node_type: &NodeType) -> &NodeStyle {
        self.node_styles
            .get(node_type)
            .unwrap_or_else(|| self.node_styles.get(&NodeType::Service).unwrap())
    }
...
fn make_node_styles(
    entries: Vec<(NodeType, &str, &str, &str, &str, &str, &str)>,
) -> HashMap<NodeType, NodeStyle> {
    entries
        .into_iter()
        .map(|(nt, fill, stroke, text, type_c, tag_bg, tag_text)| {
            (
                nt,
                NodeStyle {
                    fill: fill.into(),
...
fn light_theme() -> Theme {
    Theme {
        ...
        group_style: GroupStyle {
            ...
            strokes: vec!["#CBD5E0".into(), "#E2E8F0".into(), "#EDF2F7".into()],
...
fn dark_theme() -> Theme {
    Theme {
        ...
        group_style: GroupStyle {
            ...
            strokes: vec!["#4A5568".into(), "#2D3748".into(), "#1A202C".into()],
...
fn blueprint_theme() -> Theme {
    Theme {
        ...
        group_style: GroupStyle {
            ...
            strokes: vec!["#2980B9".into(), "#1F6FA3".into(), "#155A8A".into()],
...
fn mono_theme() -> Theme {
    Theme {
        ...
        group_style: GroupStyle {
            ...
            strokes: vec!["#CCCCCC".into(), "#DDDDDD".into(), "#EEEEEE".into()],
